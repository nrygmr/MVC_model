...
public class Controller {
    ...
    public Controller(View theView, Model theModel) {
        ...
        this.theView.choosingTypeListener(new DietTypeListener());
        this.theView.addButtonActionListener(new AddButtonListener());
        this.theView.deleteButtonListener(new DeleteButtonListener());
    }


    class DietTypeListener implements ActionListener {
